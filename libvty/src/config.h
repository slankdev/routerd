...
/* path to libyang plugins */
#define LIBYANG_PLUGINS_PATH "/usr/lib/frr/libyang_plugins"
...
#define PACKAGE_STRING "frr 7.2-dev"
...
#define PACKAGE_VERSION "7.2-dev"
