/* interface => "interface IFNAME [vrf NAME$vrfname]" */
...
DEFUN_CMD_FUNC_TEXT(interface)
{
	...
	return interface_magic(self, vty, argc, argv, ifname, vrfname);
}

/* no_interface => "no interface IFNAME [vrf NAME$vrfname]" */
...
DEFUN_CMD_FUNC_TEXT(no_interface)
{
	...
	return no_interface_magic(self, vty, argc, argv, ifname, vrfname);
}
